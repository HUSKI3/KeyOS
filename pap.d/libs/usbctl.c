...
static const struct option long_options[] = {
    ...
    { "helpp",     no_argument,       NULL, 'h' },
    { "called",   no_argument,       NULL, 'c' },
    { 0,          0,                 NULL, 0   },
};
...
// int argc, char *argv[]
int process_usb(int count, char *args[])
{
...
/*    for (int i = 1; i < count; ++i) {
    ...
    for (;;) {
        c = getopt_long(count, args, "l:L:n:a:p:d:r:c:w:s:hvefR",
